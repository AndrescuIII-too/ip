...
public class AddTaskDeadline extends Command {
    ...
    private static final HashSet<String> FIELDS = new HashSet<>(List.of("by"));

    public AddTaskDeadline(String description, List<Parameter> parameters) {
    ...
    public List<Response> execute(Context context) {
        ...
        try {
            fields = Parser.validateFields(this.parameters, AddTaskDeadline.FIELDS);
